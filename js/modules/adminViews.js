...
export async function superAdminHomeView() {
  ...
  return `
    <div class="page-head">
      <div><span class="tag blue">SUPER ADMIN</span><h2>Club Oversight Dashboard</h2><p>System configuration and active statistics.</p></div>
    </div>
    ...
    <section class="card">
      ...
      <div class="actions" style="margin-top:10px;">
        <button class="primary" data-go-page="flights">⚙️ Manage Flights & Members</button>
        <button class="pill" data-go-page="master">📆 Master Timetable</button>
        <button class="pill" data-go-page="finance">💳 Finance & Credit</button>
        <button class="pill" data-go-page="ads">📢 Ad Management</button>
      </div>
    </section>`;
}
      ...
      <div class="field">
        ...
        <select id="financeCreditMember" required>
          <option value="" disabled ${selectedFinanceCreditMemberId ? "" : "selected"}>
            ${selectedFinanceFlightId ? "Choose member in selected level" : "Choose member in selected level"}
          </option>
