...
export function bindAdminViews() {
  ...
  document.querySelectorAll("[data-print-finance], [data-print-audit], [data-print-advertising]").forEach(button => button.onclick = () => window.print());
